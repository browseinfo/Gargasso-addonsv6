...
file_path = join(addons.get_module_resource('account_custom_report'),'report/account_export_annexure_report1.rml')
report_sxw.report_sxw(
    'report.account.invoice.export.annexure.report1',
    'account.invoice',
    file_path,
    parser=account_export_annexure_report,
    header=False
